...
def data_2013():
    i = 0
    main_avg = []
    for a in pd.read_csv('aqm2013.csv', chunksize=24):
        add = 0
        avg = 0.0
        data = []
...
def data_2014():
    i = 0
    main_avg = []
    for a in pd.read_csv('aqm2014.csv', chunksize=24):
        add = 0
        avg = 0.0
        data = []
        df = pd.DataFrame(data=a)
...
def data_2015():
    i = 0
    main_avg = []
    for a in pd.read_csv('aqm2015.csv', chunksize=24):
        add = 0
        avg = 0.0
        data = []
        df = pd.DataFrame(data=a)
...
def data_2016():
    i = 0
    main_avg = []
    for a in pd.read_csv('aqm2016.csv', chunksize=24):
        add = 0
        avg = 0.0
        data = []
        df = pd.DataFrame(data=a)
